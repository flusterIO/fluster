...
import 'package:fluster/features/command_palette/data/command_palette_tree/categories/navigation/navigation_command_palette_category.dart';
...
class CommandPaletteRoot extends CommandPaletteCategory {
  const CommandPaletteRoot()
    : super(
        ...
        items: const <CommandPaletteEntry>[NavigationCommandPaletteCategory()],
      );
