...
class _$PanelLeftStateImpl implements _PanelLeftState {
  const _$PanelLeftStateImpl({required this.open});
...
abstract class _PanelLeftState implements PanelLeftState {
  const factory _PanelLeftState({required final bool open}) =
      _$PanelLeftStateImpl;
