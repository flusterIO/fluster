...
class _$PanelRightStateImpl extends _PanelRightState {
  const _$PanelRightStateImpl({this.open = true}) : super._();
...
abstract class _PanelRightState extends PanelRightState {
  const factory _PanelRightState({final bool open}) = _$PanelRightStateImpl;
  const _PanelRightState._() : super._();
