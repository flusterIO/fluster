 ...
 */
user_provided_id: string | null; title: string; summary: string | null; tags: SharedTaggableModel[]; subject: SharedTaggableModel | null; topic: SharedTaggableModel | null; list_id: string | null; list_index: bigint | null }
 ...
 */
file_path: string; raw_body: string; ctime: bigint; 
/**
