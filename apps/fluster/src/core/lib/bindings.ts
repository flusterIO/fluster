 ...
 */
"ModelFull"
export type MdxNoteGroup = { mdx: MdxNoteModel; front_matter: FrontMatterModel; tags: SharedTaggableModel[] }
export type MdxNoteModel = { id: string; raw_body: string; file_path: string | null; front_matter_id: string; ctime: string | null; 
/**
