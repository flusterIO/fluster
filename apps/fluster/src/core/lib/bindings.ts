 ...
 */
healthy: boolean }
export type DictionaryEntryModel = { label: string; body: string; ctime: bigint }
 ...
 */
export type FrontMatterModel = { id: string; 
/**
 * The user_provided_id is the id field as it appears in the user's note.  The id field in
 * this struct is generated by Surreal.
 */
user_provided_id: string | null; title: string; summary: string | null; tags: SharedTaggableModel[]; subject: SharedTaggableModel | null; topic: SharedTaggableModel | null; list_id: string | null; list_index: bigint | null; mdx_note_file_path: string }
