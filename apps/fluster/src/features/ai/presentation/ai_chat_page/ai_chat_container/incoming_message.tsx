    ...
    <div className="w-full flex flex-col justify-center items-center">
      <ContextMenu>
        <ContextMenuTrigger asChild>
          <div className="w-[min(1080px,calc(100%-4rem))] p-4 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl rounded-br-sm border bg-card [&_think]:text-sm [&_think]:italic">
            <ErrorBoundary fallbackRender={() => null}>
              <MdxContent debounceTimeout={50} mdx={data.body} />
            </ErrorBoundary>
          </div>
        </ContextMenuTrigger>
        <ContextMenuPortal>
