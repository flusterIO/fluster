      ...
      <Form {...form}>
        <SettingPageContainer>
          ...
          <FilePathInput
            ...
            desc="An optional path within your notes directory that points to a .bib file."
            classes={{
          ...
          <FilePathInput
            ...
            name="cslPath"
            label="CSL File Path"
            desc="An optional path within your note's root directory that points to a .csl file to be used for citation formatting."
            classes={{
              formItem: "w-full min-w-full",
              container: "w-full min-w-full",
            }}
