...
const MyWorkPage = async (): Promise<ReactNode> => {
    ...
    return (
        <div className="w-full pb-16 flex flex-col justify-start items-center">
            <div className="px-4 py-3 w-full flex flex-row justify-start items-center">
                <Link href="/" className="text-bold">
                    Fluster
                </Link>
            </div>
            <div className="mt-16 prose dark:prose-invert prose-code:before:content-none prose-code:after:content-none prose-code:bg-[--shiki-light-bg] dark:prose-code:bg-[--shiki-dark-bg] [&_code_*]:text-[--shiki-light] dark:[&_code_*]:text-[--shiki-dark] max-w-[min(90vw,1080px)]">
