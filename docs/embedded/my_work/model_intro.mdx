...
Don't worry, we'll circle back around to the Big Bang and cosmic inflation, but first, let's tackle gravity via the equivalence principle. As you'll see, gravity, cosmic inflation and time itself becme a single physical phenomenon as observed from alternate reference frames, but let's start with gravity.
