...
class AndroidEnvironment {
  ...
  Future<Map<String, String>> buildEnvironment() async {
    ...
    final runRustTool =
        Platform.isWindows ? 'run_build_tool_renamed.cmd' : 'run_build_tool_renamed.sh';

    final packagePath = (await Isolate.resolvePackageUri(
            Uri.parse('package:build_tool_renamed/buildtool.dart')))!
        .toFilePath();
    ...
    // Make sure that run_build_tool_renamed is working properly even initially launched directly
    // through dart run.
    final toolTempDir =
