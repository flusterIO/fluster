...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if (WIN32)
        ...
        execute_process(COMMAND chmod +x "${cargokit_cmake_root}/run_build_tool_renamed${SCRIPT_EXTENSION}")
    endif()
    ...
    if (CMAKE_CONFIGURATION_TYPES AND ${CMAKE_VERSION} VERSION_LESS "3.20.0")
        foreach(CONFIG IN LISTS CMAKE_CONFIGURATION_TYPES)
            add_custom_command(
                ...
                "${cargokit_cmake_root}/run_build_tool_renamed${SCRIPT_EXTENSION}" build-cmake
                VERBATIM
            )
        endforeach()
    else()
