...
(
    echo import 'package:build_tool_renamed/build_tool_renamed.dart' as build_tool_renamed;
    echo void main^(List^<String^> args^) ^{
    echo    build_tool_renamed.runMain^(args^);
    echo ^}
) >bin\build_tool_renamed_runner.dart

SET PRECOMPILED=bin\build_tool_renamed_runner.dill
