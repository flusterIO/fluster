...
Future<Regex> getTagRegularExpression() =>
    RustLib.instance.api
        .crateApiModelsTaggableTaggableGetTagRegularExpression();
...
class Taggable {
  final String value;
  final TaggableTypeEnum tagType;
  ...
  static Future<TagFromContentResult> fromMdxContent({
    required ParsedEntity data,
      ...
      .crateApiModelsTaggableTaggableTaggableFromMdxContent(data: data);

  static Future<List<Taggable>> fromPodData({required ParsedEntity data}) =>
      RustLib.instance.api.crateApiModelsTaggableTaggableTaggableFromPodData(
        data: data,
      );
