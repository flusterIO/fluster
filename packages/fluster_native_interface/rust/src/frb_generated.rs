...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1350829662;
...
fn wire__crate__api__global_actions__parse_directory__parse_directory__sync_directory_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec,_,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "sync_directory", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            ...
            let api_dir_path = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context| async move {
                    transform_result_sse::<_, ()>((move || async move {
                         let output_ok = Result::<_,()>::Ok({ crate::api::global_actions::parse_directory::parse_directory::sync_directory(&api_dir_path).await; })?;   Ok(output_ok)
                    })().await)
                } })
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => {
            wire__crate__api__global_actions__parse_directory__parse_directory__sync_directory_impl(
                port,
                ptr,
                rust_vec_len,
                data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__search__get_text_similarity__get_text_similarity_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__fs__fs_utils__path_exists_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
