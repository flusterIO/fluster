...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 777868054;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
                        5 => wire__crate__api__global_actions__parse_directory__parse_fs_directory__sync_directory_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
