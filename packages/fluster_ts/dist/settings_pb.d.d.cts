...
declare class SettingItem extends jspb.Message {
  getLabel(): string;
...
declare class SettingField extends jspb.Message {
  getLabel(): string;
  setLabel(value: string): void;
...
declare namespace SettingField {
  export type AsObject = {
    label: string,
    value?: google_protobuf_any_pb.Any.AsObject,
  }
...
declare class GetUserSettingsResponse extends jspb.Message {
...
declare namespace GetUserSettingsResponse {
  export type AsObject = {
    settingsList: Array<SettingField.AsObject>,
  }
}

export { GetUserSettingsResponse, SettingField, SettingItem };
